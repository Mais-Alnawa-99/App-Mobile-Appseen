      ...
      <View style={[styles.viewStyle, props.viewStyle]}>
          ...
          <TextInput
            style={[
              props.disabled ? styles.inputDisable : styles.input,
              {
                ...
                borderColor:
                  props.required || props.error ? 'red' : colors.border,
                borderWidth:
            ...
            <PhoneInput
              ...
              onChangeCountry={
                ...
                coun => {
                  ...
                  props?.setCountryCode &&
                    props.setCountryCode(coun.callingCode[0]);
                }
                // : () => {}
              }
              {...props}
        ...
        {(props.dropdown || props.type == 'dropdown') && (
          <Dropdown
            ...
            renderRightIcon={() => {}}
            renderLeftIcon={() => (
              <AntDesign name={'down'} size={15 * BW()} color={colors.gray} />
            )}
            renderItem={
        ...
        {!!props.error && typeof props.error == 'string' && (
          <Text style={styles.requiredText} h4>
            {props.error}
          </Text>
        )}
      </View>
